...
struct InlineMultipleChoiceQuestionView : View {
    ...
    var body: some View {
        ...
        VStack {
            HStack {
                Text(question.title).font(.body).fontWeight(.semibold).foregroundColor(Color(.label)).opacity(0.8).padding(4)
...
struct SurveyView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        SurveyView(survey: SurveyScreen).preferredColorScheme(.light)
